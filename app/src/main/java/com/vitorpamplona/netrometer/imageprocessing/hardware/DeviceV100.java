 ...
 */
public class DeviceV100 extends AbstractDevice<DeviceV100> {

    public DeviceV100(long id, String what, String model, String where) {
    ...
    public DeviceV100 clone() {
        DeviceV100 d = new DeviceV100();
        copyInto(d);
        return d;
    }
